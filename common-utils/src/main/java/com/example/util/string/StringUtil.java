...
import com.example.util.json.JSONArray;
import com.example.util.json.JSONConfig;
import com.example.util.json.JSONObject;
import com.example.util.validate.ObjectCensor;
			...
			for (int i = 0; i < fields.length; i++) {
				...
				try {// 对于hibernate影射的值对象主键字段,例如没有setCustid()方法
					...
					if (datatype.equals("java.util.Date")) {
						...
						method.invoke(vo, new Date[] { mydate });// 调用setXXXX方法
					}
